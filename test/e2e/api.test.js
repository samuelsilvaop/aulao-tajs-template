...
describe('API E2E test Suite', () => {
    ...
    describe('/login', () => {
        ...
        it('should login successfully given user and password', async () => {
            ...
            assert.strictEqual(
                result.status, 
                expected, 
                `status code should be ${expected}, actual ${result.status}`
            )
    ...
    describe('/', () => {
        ...
        it('should not be a allowed to access private without a token', async () => {
            const input = {
                headers: {
                    authorization: ''
                }
        ...
        it('should be a allowed to access private data with valid token', async () => {
            const input = {
                headers: {
